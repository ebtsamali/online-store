...
- Folder: `.squad/stories/middelware/middelware-bug/intake.md`
...
```
when login as admin, he can visit users pages, and after redirect to dashboard page he can return to login page, it should when he logged in can't go to login page in admin or users
fix these issues
```
