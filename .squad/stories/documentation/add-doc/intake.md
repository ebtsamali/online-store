...
- Folder: `.squad/stories/documentation/add-doc/intake.md`
...
- **Feature slug (folder under `plans/`):** `documentation`
...
```
add git readmi file
and add readmi for frontend app and docs for backend
in docs and readmi, write every thing in details to make it easy for others to work on it
```
